...
import { Breadcrumb, Button, ButtonGroup, Row, Col, InputGroup, Image, Form, Dropdown, Card, Table} from "@themesberg/react-bootstrap";
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faHome, faPlus, faCog, faCheck, faSearch, faSlidersH } from '@fortawesome/free-solid-svg-icons';
import Jacksondaniel from "../assets/img/Jacksondaniel.jpg";
            ...
            <tbody>             
                <tr>
                    <td>
                        ...
                        <Image src={Jacksondaniel} className="user-avatar rounded-circle me-3" />
                        <div className="d-block">
                            <span className="fw-bold">Dr. Daniel Jackson</span>
                        </div>
                        </Card.Link>
                    </td>
                    <td>drjackson@stargate.com</td>
                    <td>Anthropologist, Egytpologist, Humanitarian</td>
